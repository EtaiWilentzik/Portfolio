...
export function Hero() {
  ...
  I hold a BSc in Computer Science and have experience with various technologies.
          ...
          <a href="https://github.com/EtaiWilentzik" className="btn btn--full margin-right-sm center-text">
             github  
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/etai-wilentzik/" className="btn btn--outline">
           linkedin 
            <FaLinkedin />
          </a>
